Clerk is already installed and connected. Wire it into the Next.js app: provide, auth pages, redirects, route protection, and user menu.

## Design

Use Clerk's `dark` theme from `@clerk/ui/themes` as the base.

Override Clerk appearance varibles using the app's existing CSS variables. Do not hardcode colors.
